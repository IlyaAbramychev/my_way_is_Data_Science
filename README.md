...
| 14 | [Прогноз оттока клиентов телеком-оператора (ТелеДом)](#14-прогноз-оттока-клиентов-телеком-оператора-теледом) | Обучение модели машинного обучения для предсказания оттока клиентов по данным об услугах и договорах. | `pandas`, `numpy`, `matplotlib`, `seaborn`, `sklearn`, `catboost`, `lightgbm` |
...
### [1. Музыка больших городов](1 big_cities_music/music_project.ipynb.ipynb)
...
### [2. Исследование надежности заемщиков](2 analysis_of_bank_data/analysis_of_bank_data.ipynb)
...
### [3. Исследование объявлений о продаже квартир](3 exploratory_data_analysis/Исследовательский анализ данных - проект.ipynb)
...
### [4. Статистический анализ данных](4 statistical_data_analysis/project.ipynb)
...
### [5. Анализ факторов успеха видеоигр](5 the_composite_project_1/project.ipynb)
...
### [6. Прогнозная модель «ЭкоФерма» для отбора буренок](6 linear_models_in_machine_learning)
...
### [7. Персонализация предложений постоянным клиентам](7  supervised_learning_the_quality_of_the_model/Персонализация предложений постоянным клиентам.ipynb)
...
### [8. Предсказание удовлетворенности сотрудников и их увольнения](8 composite_project — 2 HR_analytics/Предсказание удовлетворенности сотрудников в компании и их увольнения.ipynb)
...
### [9. Выбор локации для скважины](Выбор локации для скважины.ipynb)
...
### [10. Определение стоимости автомобилей](Определение стоимости автомобиля.ipynb)
...
---
### [11. Прогнозирование заказов такси](Forecasting taxi orders.ipynb)
...
- `TimeSeriesSplit`
---
### [12. Классификация токсичных комментариев (Викишоп)](Viki shop BERT.ipynb)
...
### [13. Определение возраста покупателей](Определение возраста покупателей.ipynb)
...
### [14. Прогноз оттока клиентов телеком-оператора (ТелеДом)](Forecasting the outflow of customers from the telecom operator TeleDom.ipynb)
